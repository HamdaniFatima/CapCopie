...
from ..models import Capteur,Equipe, Quiz,Forum, Student, TakenQuiz, User, Subject, Profile,Comment, Domaine, TypeCapteur
...
def CapteurListView(request):
    ...
    template_name = 'chercher/capteur.html'
...
class ExpertListView(ListView):
    ...
    def get_queryset(self):
        ...
        queryset = Student.objects.filter( Q(interests__in=student_interests) | 
    Q(expert=True))
...
class CapteursView(ListView):
    model = Capteur
    context_object_name = 'quizzes'
    template_name = 'capteurs/home_page.html'
