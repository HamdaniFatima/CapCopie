...
class Quiz(models.Model):
    ...
    domaine = models.ForeignKey(Domaine, on_delete=models.CASCADE,verbose_name= u"Domaines d'application  ", related_name='domaines_projet')
    subject = models.ManyToManyField(Subject, verbose_name= u"Mots Clés  ", related_name='projets')
    ...
    file_1 = models.FileField(upload_to='images/',verbose_name=u"Télécharger field 2 ", null=True, blank=True)
    file_2 = models.FileField(upload_to='images/',verbose_name=u"Télécharger field 3 ", null=True, blank=True)
...
class Student(models.Model):
    ...
    image = models.ImageField(upload_to='media/', default='default.jpg', verbose_name=u"Figure associée à votre profil", null=True)
    nom = models.CharField(max_length=270,verbose_name= u"Nom : ",  null=True, blank=True)
    prenom = models.CharField(max_length=270,verbose_name= u"Prénom : ",  null=True, blank=True)
    adresse_email = models.EmailField(max_length=100,verbose_name=u"Adresse email de contact : ",   null=True, blank=True)
    composante = models.CharField(max_length=100,verbose_name=u"Composante : ",   null=True, blank=True)
    fonction = models.CharField(max_length=270,verbose_name= u"Fonction : ",  null=True, blank=True)
    domaine = models.ManyToManyField(Domaine, verbose_name= u"Domaines de Compétences  ", related_name='domaines_expert')
    interests = models.ManyToManyField(Subject, verbose_name= u"Mots Clés  ", related_name='interested_student')
